...
- automated frontend, Rust and Windows release verification;
- post-merge stale-state, config-selector, network-target, dependency and release hardening;
- updated roadmap, decisions, tasks, reports, README and architecture docs.

Related work:

- `0013-add-proxy-client-adapters-and-happ-mvp` - Done
- `0014-post-merge-deep-audit` - Done
