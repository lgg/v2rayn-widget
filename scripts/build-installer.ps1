...
if (-not (Test-Path $tauriCli)) {
    throw "Tauri CLI not found. Run npm install in src\frontend."
}
...
Invoke-CheckedCommand { & $tauriCli build --runner $toolchainCargo --bundles nsis --config "tauri.installer.conf.json" --ci }
